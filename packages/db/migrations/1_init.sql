...
create table image (
    ...
    created_at datetime(3) default CURRENT_TIMESTAMP(3),
    constraint image_item_id_fkey foreign key (item_id) references item (id) on update cascade
);
...
create table thumbnail (
    ...
    constraint thumbnail_item_id_fkey foreign key (item_id) references item (id) on update cascade
);
...
create table video (
    ...
    constraint video_item_id_fkey foreign key (item_id) references item (id) on update cascade
);